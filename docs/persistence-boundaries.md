...
- **Heroes are 12, not 13.** Honcho is removed from scope per J7 2026-07-09; see `docs/runtime-state.md` §2 (Honcho API row, see decommission-pending note). Container still bound to `:8000`; tracked as `kanban/backlog.md` E3-T15.
